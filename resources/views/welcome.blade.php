...
<head>
    ...
    <title>Curso-PHP-Laravel-Completo-E-Total</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content=""/>
    <meta name="keywords" content="laravel,curso,webschoolio"/>
        ...
        <nav class="navbar navbar-default">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="#" data-nav-section="testimonials"><span>Participar !</span></a></li>
            ...
            <div class="text-inner">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <h1 class="to-animate">Curso-PHP-Laravel-Completo-E-Total</h1>
    ...
    <div class="container">
        <div class="row row-bottom-padded-lg">
            ...
            <div class="fh5co-block to-animate" style="background-image: url(images/img_10.jpg); min-height: 378px; ">
                ...
                <div class="overlay"></div>
                <div class="fh5co-text">
                    <h2>Quer aprender sobre o Laravel?</h2>
                    <p>Um curso totalmente grátis fornecido pela Webschool.io, não perca essa oportunidade de conhecer o
                        Laravel criando o seu proprio e-commerce!</p>
                </div>
            </div>
...
<section id="fh5co-testimonials" data-section="testimonials">
    <div class="container">
        <div class="row">
            <div class="col-md-12 section-heading text-center">
                <h2 class="to-animate">Participar !</h2>
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 subtext to-animate">
                        <h3>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia,
                            there live the blind texts.</h3>
        ...
        <div class="row">
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="fh5co-counter to-animate">
                    ...
                    <span class="fh5co-counter-number js-counter" data-from="0" data-to="89" data-speed="5000"
                          data-refresh-interval="50">89</span>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="fh5co-counter to-animate">
                    ...
                    <span class="fh5co-counter-number js-counter" data-from="0" data-to="2343409" data-speed="5000"
                          data-refresh-interval="50">2343409</span>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="fh5co-counter to-animate">
                    ...
                    <span class="fh5co-counter-number js-counter" data-from="0" data-to="1302" data-speed="5000"
                          data-refresh-interval="50">1302</span>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="fh5co-counter to-animate">
                    ...
                    <span class="fh5co-counter-number js-counter" data-from="0" data-to="52" data-speed="5000"
                          data-refresh-interval="50">52</span>
